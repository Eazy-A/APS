...
//                boolean hasPunct = (sign == '.' || sign == ',' || sign == '!' || sign == '?');
//                String clean = hasPunct ? words[i].substring(0, words[i].length() - 1) : words[i];
//
//                boolean capitalized = Character.isUpperCase(clean.charAt(0));
//                SLLNode<MapEntry<String, String>> result = map.search(clean.toLowerCase());
//
//                if (result != null) {
//                    clean = result.element.value;
//                    if (capitalized) {
//                        clean = Character.toUpperCase(clean.charAt(0)) + clean.substring(1);
//                    }
//                }
//                if (hasPunct) clean += sign;
//                words[i] = clean;
//            }
